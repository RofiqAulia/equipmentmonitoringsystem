        ...
        <form id="retrieval-form" onsubmit="handleConfirmRetrieval(event)" class="space-y-5 pt-2">
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-1.5 mb-2">
                    <button type="button" onclick="setPresetNote('Pengambilan rutin operasional', 'notes')" class="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 hover:bg-cyan-500/20 hover:text-cyan-600 dark:hover:text-cyan-400 text-[10px] font-semibold text-slate-600 dark:text-slate-400 rounded-lg border border-slate-200 dark:border-slate-700 transition">🛠️ Rutin Operasional</button>
                    <button type="button" onclick="setPresetNote('Kebutuhan perbaikan / maintenance mendesak', 'notes')" class="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 hover:bg-cyan-500/20 hover:text-cyan-600 dark:hover:text-cyan-400 text-[10px] font-semibold text-slate-600 dark:text-slate-400 rounded-lg border border-slate-200 dark:border-slate-700 transition">⚡ Repair / Maintenance</button>
                    <button type="button" onclick="setPresetNote('Pengisian stok / refill area kerja', 'notes')" class="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 hover:bg-cyan-500/20 hover:text-cyan-600 dark:hover:text-cyan-400 text-[10px] font-semibold text-slate-600 dark:text-slate-400 rounded-lg border border-slate-200 dark:border-slate-700 transition">📦 Refill Area Kerja</button>
                    <button type="button" onclick="setPresetNote('Pengambilan karena barang rusak / defect', 'notes')" class="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 hover:bg-cyan-500/20 hover:text-cyan-600 dark:hover:text-cyan-400 text-[10px] font-semibold text-slate-600 dark:text-slate-400 rounded-lg border border-slate-200 dark:border-slate-700 transition">⚠️ Rusak</button>
                    <button type="button" onclick="setPresetNote('Kebutuhan pesanan khusus / PO', 'notes')" class="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 hover:bg-cyan-500/20 hover:text-cyan-600 dark:hover:text-cyan-400 text-[10px] font-semibold text-slate-600 dark:text-slate-400 rounded-lg border border-slate-200 dark:border-slate-700 transition">🎯 Pesanan / PO</button>
                </div>
                <textarea id="notes" rows="2" placeholder="Pilih preset di atas atau ketik catatan kustom..."
